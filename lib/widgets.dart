...
class _DraggableWidgetState extends State<DraggableWidget> with TickerProviderStateMixin{
  ...
  void insShapesGameInfo(String gname,int m,var s, var e,String cid) async {
    ...
    String plasc = json.encode(playassoc);

    final response = await http.post(
        'https://braintrainapi.com/btapi/player_associations',
        headers: {"Content-Type": "application/json"}, body: plasc);
  ...
  //dispose of animations and sound when done.
  ...
  dispose() {
    ...
    insShapesGameInfo(gameName,match,start,end,cid);
            ...
            new Positioned(left: screenWidth/2 - 100/2,
              ...
              child: DragTarget(
                ...
                onAccept: (String data) {
                  if(data == answerData) {
                    //Keep score for child on how many they match
                    match = match + 1;
                    ...
                    soundStream = Future.delayed(const Duration(seconds: 1), () {
                    }).asStream().listen((NULL) {
                    ...
                    if(num == 1) {
                      ...
                      soundStream = Future.delayed(const Duration(milliseconds: 2500), () {
                      }).asStream().listen((NULL) {
